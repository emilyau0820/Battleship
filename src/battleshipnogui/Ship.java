...
Project: Battleship
File: Ship.java
Description: Represents a vessel occupying multiple connected blocks on the game grid, encapsulates the position, size, and hit state of a battleship. Compatible without GUI.
